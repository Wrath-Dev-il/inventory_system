                            ...
                            <table class="admin-customers__table">
                                <thead>
                                    ...
                                    <tr class="admin-customers__filters">
                                        @foreach (['customer_no' => 'No', 'customer_name' => 'Customer Name', 'tin' => 'Tin', 'price_reference' => 'Price Reference', 'discount_percent' => '%Disc', 'sales_agent' => 'Sales Agent', 'address' => 'Address', 'date_started' => 'Date Started', 'terms' => 'Terms'] as $column => $label)
                                            <th>
