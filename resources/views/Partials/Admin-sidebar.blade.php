@php
    ...
    $salesActive = request()->routeIs('admin.sales-order.*') || request()->routeIs('admin.sales-listing.*') || request()->routeIs('admin.sales-quotation.*');
    ...
    <nav class="admin-sidebar__nav">
        ...
        <div class="admin-sidebar__group {{ $salesActive ? 'is-active is-open' : '' }}" data-sidebar-group>
            ...
            <div class="admin-sidebar__submenu" id="admin-sales-menu">
                ...
                <a href="{{ route('admin.sales-listing.index') }}" class="admin-sidebar__sublink {{ request()->routeIs('admin.sales-listing.*') ? 'is-active' : '' }}">
                    <span class="admin-sidebar__subicon-box">
                        <svg class="admin-sidebar__subicon" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                            <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                            <circle cx="9" cy="7" r="4" stroke="currentColor" stroke-width="2"/>
